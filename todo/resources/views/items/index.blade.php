                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-info">
                            ...
                            @endif
                            <h4 class="card-title ">YAPILACAKLAR TABLOSU</h4>
                                            ...
                                            @foreach ($items as $item)
                                                ...
                                                @if ($item->completed == '1')
                                                    <td><a data-id="{{ $item->completed }}" data-toggle="modal"
                                                            data-target="#myModal"><i style="color:green" class="fas fa-check-circle"></i><a>
                                                    </td>
                                                @else

                                                    <td><a data-id="{{ $item->completed == '0' }}" data-toggle="modal"
                                                            data-target="#myModal"><i style="color:red" class="fas fa-minus-circle"></i><a>
                                                    </td>
